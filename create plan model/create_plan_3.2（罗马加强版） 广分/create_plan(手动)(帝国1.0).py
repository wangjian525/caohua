...
def create_plan(df, score_image):
    ...
    df = df[df['game_id'].isin([1001787, 1001810])]
    ad_account_id_group = np.array([9088, 9089, 9090, 9091, 9092, 9093])
...
def main_model():
    ...
    plan_result['cpa_bid'] = plan_result['cpa_bid'].apply(lambda x: x if x >= 600 else random.randint(600, 630))
    ...
    plan_result['web_url'] = 'https://www.chengzijianzhan.com/tetris/page/7008721244007120903/'
