...
def etl_image(start, end, n):
    ...
    columns = ['ad_account_id', 'image_id', 'ad_im_amount', 'ad_im_create_role_num', 'ad_im_new_role_money',
               'ad_im_pay_role_user_num', 'ad_im_source_num', 'ad_im_valid_source_num',
               'ad_im_pay_rate', 'ad_im_create_role_cost', 'ad_im_create_role_pay_cost',
               'ad_im_valid_source_rate', 'ad_im_create_role_roi', 'model_run_datetime']
    ...
    for date in date_list:
        ...
        # 获取素材窗口期数据
        DataList = getAdImData(conn1, begin, end, n=n)
