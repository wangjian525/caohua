...
def create_plan(df, score_image):
    ...
    ad_account_id_group = np.array([7771, 7772, 7773, 7856])
...
def main_model():
    ...
    if plan_result.shape[0] > 30:
        plan_result = plan_result.sample(30, weights=plan_result['weight'])
    ...
    plan_result['web_url'] = 'https://www.chengzijianzhan.com/tetris/page/6991725910375268360/'
    plan_result['op_id'] = 13268
    plan_result['district'] = 'CITY'
    plan_result['flag'] = 'SSR_'
    # 人群包报错，直接先赋值为[]
