...
def get_train_df():
    # 获取账号、素材、账号+素材维度的数据
    # 读取近期数据
    train_im_1, train_ad_1 = etl_data(start='2021-04-23',
    ...
    # n=3
    train_im_3, train_ad_3 = etl_data(start='2021-04-23',
    ...
    # n=5
    train_im_5, train_ad_5 = etl_data(start='2021-04-23',
    ...
    # n=7
    train_im_7, train_ad_7 = etl_data(start='2021-04-23',
    ...
    df.drop(['budget', 'cpa_bid', 'channel_id', 'source_id', 'amount', 'roi', 'pay_rate', 'create_role_num','pay_role_user_num',
    ...
    df = df[df['create_time'] >= pd.datetime.now() - pd.DateOffset(180)]  # 取近半年的数据
    # print(df.shape)
    # print(plan_create_train.shape)
...
def main_model():
    ...
    plan_create['rank_ad_im'] = plan_create.groupby(['ad_account_id', 'image_id', 'game_id'])['prob'].rank(ascending=False,method='first')
    plan_result = plan_create[plan_create['rank_ad_im'] <= 2]
    ...
    plan_result['web_url'] ='https://www.chengzijianzhan.com/tetris/page/6959821665392082958/'
