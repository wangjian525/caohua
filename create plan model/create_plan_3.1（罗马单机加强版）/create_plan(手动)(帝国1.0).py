...
def create_plan(df, score_image):
    ...
    df = df[df['game_id'].isin([1001788, 1001784, 1001668])]
...
def main_model():
    ...
    plan_result['cpa_bid'] = plan_result['cpa_bid'].apply(lambda x: x if x >= 640 else random.randint(640, 680))
    ...
    plan_result['web_url'] = 'https://www.chengzijianzhan.com/tetris/page/7005967621104451598/'
