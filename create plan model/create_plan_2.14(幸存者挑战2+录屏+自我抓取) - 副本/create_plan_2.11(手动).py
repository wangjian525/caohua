...
def get_score_image():
    ...
    sql = 'select image_id,label_ids from dws.dws_image_score_d where media_id=10 and score>=520 and dt=CURRENT_DATE and label_ids=27 group by image_id,label_ids'
