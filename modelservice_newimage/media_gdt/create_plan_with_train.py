...
"""
   ...
   Description :   新建计划：测新计划自动化组合（末日广点通）
   Author :        royce.mao
   date：          2021/7/5 20:25
"""
...
from media_gdt.script.realtime_df import DataRealTime, get_game_id, image_elements, location_type  ## 采集实时数据类
...
class NewCreatePlan(object):
    ...
    def plan_dtc_screen(plan_prob, plan, plan_out_num, is_test=True):
        ...
        plan_result['game_name'] = '幸存者挑战' ## TODO:新字段
        plan_result['platform'] = 1 ## TODO:新字段
        plan_result['budget_mode'] = 0  # 不限预算
        plan_result['daily_budget'] = 0  # 不限预算
        plan_result['promoted_object_id'] = '1111059412' ## TODO:老包的应用id为'1111059412'
