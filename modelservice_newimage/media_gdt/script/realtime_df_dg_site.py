...
"""
   ...
   Description :   计划创建相关：实时数据采集（广点通-帝国）
   Author :        royce.mao
...
class DataRealTime(object):
    ...
    def get_score_images():
        ...
        sql = 'select image_id,label_ids,model_run_datetime,score from dws.dws_image_score_d where media_id=16 and dt=CURRENT_DATE'
...
def location_type(dic):
    ...
    dic['geo_location']['location_types'] = ['LIVE_IN']
