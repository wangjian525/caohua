...
def main_model():
    ...
    plan_result = plan_result[plan_result['site_set'] == "['SITE_SET_MOMENTS']"]  # 只有朋友圈能跑付费次数
    ...
    # 调低ROI系数  ##TODO
    plan_result['optimization_goal'] = plan_result['optimization_goal'].apply(lambda x: 'OPTIMIZATIONGOAL_APP_PURCHASE')   ## TODO  固定付费次数
