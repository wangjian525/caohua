...
def create_plan(df, score_image, ad_account):
    game_id = 1001447
...
def get_train_df(ad_account_id_group, site_type):
    ...
    plan_create = pd.DataFrame()
    for account_id in ad_account_id_group:
        if site_type[account_id] == "['SITE_SET_MOMENTS']":
            df_create_1 = df_create[df_create['site_set'] == site_type[account_id]]
        elif site_type[account_id] == "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']":
            df_create_1 = df_create[~((df_create['site_set'] == "['SITE_SET_MOMENTS']") | (df_create['site_set'] == "['SITE_SET_WECHAT']") | (df_create['site_set'] == "nan"))]
            df_create_1['site_set'] = df_create_1['site_set'].apply(lambda x: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']")

        plan_1 = create_plan(df_create_1, score_image, account_id)
        plan_create = plan_create.append(plan_1)
...
def main_model():
    # ad_account_id_group = np.array([8814, 8824, 8825, 8826, 9413, 9414, 9415, 9416, 9417, 9420, 8847, 8821, 8035, 8080, 8073])
    ad_account_id_group = np.array([8847, 8821, 8035, 8080, 8073, 9556, 9558])
    # ad_account_id_group = np.array([9556, 9558])
    site_type = {8814: "['SITE_SET_MOMENTS']",
                 8824: "['SITE_SET_MOMENTS']",
                 8825: "['SITE_SET_MOMENTS']",
                 8826: "['SITE_SET_MOMENTS']",
                 9413: "['SITE_SET_MOMENTS']",
                 9414: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 9415: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 9416: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 9417: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 9420: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 8847: "['SITE_SET_MOMENTS']",
                 8821: "['SITE_SET_MOMENTS']",
                 8035: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 8080: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 8073: "['SITE_SET_QQ_MUSIC_GAME', 'SITE_SET_KANDIAN', 'SITE_SET_TENCENT_NEWS', 'SITE_SET_TENCENT_VIDEO']",
                 9556: "['SITE_SET_MOMENTS']",
                 9558: "['SITE_SET_MOMENTS']"
                 }
    df, plan_create = get_train_df(ad_account_id_group, site_type)
    ...
    plan_create['rank_ad_im'] = plan_create.groupby(['ad_account_id', 'image_id'])['prob'].rank(ascending=False,
                                                                                                method='first')
    plan_create = plan_create[plan_create['rank_ad_im'] <= 1]

    plan_num = 8  ## TODO
    plan_result = pd.DataFrame()
    for account_id in ad_account_id_group:
        plan_result_1 = plan_create[plan_create['ad_account_id'] == account_id]
        plan_result_1 = plan_result_1.sample(plan_num)
        plan_result = plan_result.append(plan_result_1)
    ...
    plan_result['plan_auto_task_id'] = "11427,12063"  ## TODO
