...
def create_plan(df, score_image):
    ...
    game_id = 1001444  ## 选择包：n1计划-IOS联运-IOS联运
    ...
    ad_account_id_group = np.array([9413, 9414, 9415, 9416, 9417, 9418, 9419, 9420, 9421, 9422])
    ...
    plan['promoted_object_id'] = '1558408617'    ## TODO
...
def main_model():
    ...
    plan_result['page_spec'] = plan_result.apply(
        lambda x: {'override_canvas_head_option': 'OPTION_CREATIVE_OVERRIDE_CANVAS',
                   'page_id': '2282490795'} if x.site_set == "['SITE_SET_MOMENTS']"
        else ({'override_canvas_head_option': 'OPTION_CREATIVE_OVERRIDE_CANVAS',
               'page_id': '2282509588'} if x.site_set == "['SITE_SET_WECHAT']" else np.nan), axis=1)
    ...
    # 绝地末日
    profile_id_dict = {'9413': '586340', '9414': '586351', '9415': '586357', '9416': '586364', '9417': '586368',
                       '9418': '586375', '9419': '586379', '9420': '586382', '9421': '586386', '9422': '586393'}
