...
def load_to_hive():
    ...
    os.system("hadoop fs -put image_info_sorce_dg.csv hdfs://192.168.0.96:8020/warehouse/tablespace/managed/hive/dws.db/dws_image_score_d/dt="+run_dt+"/hr="+run_hour)
